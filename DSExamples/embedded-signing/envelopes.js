...
const FRAME_ANCESTORS = ["http://localhost", "https://larrykluger.github.io", "https://apps-d.docusign.com", 
...
const RETURN_URL = `https://larrykluger.github.io/DSExamples/embedded-signing/classicReturnUrl.html`;
const ROLE = "signer" // the role name used by the example templates
const STATIC_DOC_URL = "Web site Access Agreement.pdf";
const SUPP_DOCS_URL = "../../DSExamples/examples/docs/";
